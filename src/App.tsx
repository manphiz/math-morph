...
export default function App() {
  ...
  return (
    <div className="flex flex-col landscape:flex-row lg:flex-row h-screen w-screen bg-[#111111] text-white font-sans overflow-hidden select-none">
      ...
      {/* Canvas in portrait mode (order-1), dynamic left or right in landscape / desktop mode */}
      <div className={`order-1 ${sidebarPosition === 'left' ? 'landscape:order-2 lg:order-2' : 'landscape:order-1 lg:order-1'} w-full landscape:flex-1 lg:flex-1 h-[40vh] sm:h-[45vh] landscape:h-full lg:h-full flex-shrink-0 landscape:flex-shrink-0 lg:flex-shrink-0 min-w-0 min-h-0 overflow-hidden flex items-center justify-center`}>
      ...
      {/* Bottom scrollable controls panel in portrait mode, left or right sidebar in landscape / desktop mode */}
      <div className={`order-2 ${sidebarPosition === 'left' ? 'landscape:order-1 lg:order-1' : 'landscape:order-2 lg:order-2'} flex flex-col flex-1 landscape:flex-none lg:flex-none w-full landscape:w-[260px] sm:landscape:w-[290px] md:landscape:w-[320px] lg:w-[400px] xl:w-[420px] landscape:flex-shrink-0 lg:flex-shrink-0 landscape:h-full lg:h-full min-h-0 overflow-hidden`}>
        <Sidebar 
